...
### Validation
- Add regression coverage that preserves a legacy full-client directory while installing the new managed flavor beside it.
- Validate the migration on a real Windows host while the legacy `tunnel-client.exe` process remains live.
