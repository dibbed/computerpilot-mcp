...
- Remove the first-open race in the Windows audit interprocess lock: zero-length lock files are locked directly instead of seeding byte 0 before ownership is acquired.
