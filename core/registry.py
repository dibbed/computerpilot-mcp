...
def create_server() -> MCPServer:
    ...
    server = MCPServer(
        ...
        instructions=(
            ...
            "For browser screenshots, pass the returned path to read_file with delivery=auto for catalog-compatible ChatGPT vision; view_image is equivalent after tool refresh. "
